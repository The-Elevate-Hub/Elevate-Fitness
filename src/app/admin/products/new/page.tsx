  ...
  return (
    <div className="py-12 px-4 sm:px-6 lg:px-8 max-w-4xl">
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-serif font-bold">Create New Product</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="Complete Fitness Mastery Course"
                required
                disabled={isLoading}
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="Transform your body with our expert program"
                required
                disabled={isLoading}
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground">
                Paste a direct download link (Google Drive, Dropbox, etc.)
              </p>
            </div>
